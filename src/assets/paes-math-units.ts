...
const paesMathUnits: Subject[] = [
  {
    ...
    "units": [
      ...
      },
      {
        ...
        "description": [
          "Problemas relacionados con el ámbito de las finanzas, como por ejemplo, AFP y jubilación, créditos hipotecarios y crédito de consumo."
        ]
      },
      {
        "id": 5,
    ...
    "units": [
      ...
      },
      {
        ...
        "description": [
          ...
          "Problemas que involucren área y volumen de prismas rectos y cilindros en diversos contextos."
        ]
      },
      {
        "id": 15,
  ...
  },
  {
    ...
    "units": [
      ...
      {
        "id": 19,
        "name": "Medidas de tendencia central y rango",
        "description": [
